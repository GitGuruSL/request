...
''';
      ...
      await _requestService.createRequest(
        ...
        condition: _selectedVehicleType.name,
        budget: 0.0,
        location: _pickupController.text,
        category: 'Transportation',
        subcategory: _selectedVehicleType.name,
        deadline: _isScheduled && _scheduledTime != null 
        ...
        Expanded(
          child: GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: _isOneWay ? AppTheme.primaryColor : Colors.white,
                borderRadius: BorderRadius.circular(AppTheme.borderRadiusMedium),
              ),
              child: Text(
                'One way',
                ...
                style: AppTheme.bodyMedium.copyWith(
                  color: _isOneWay ? Colors.white : AppTheme.textPrimary,
    ...
    return Column(
      ...
      children: [
        ...
        ...vehicles.map((vehicle) => Container(
          ...
          decoration: BoxDecoration(
            color: _selectedVehicleType == vehicle['type'] ? AppTheme.primaryColor.withOpacity(0.1) : Colors.white,
            borderRadius: BorderRadius.circular(AppTheme.borderRadiusMedium),
          ),
          child: ListTile(
            leading: Icon(
              vehicle['icon'] as IconData,
              color: _selectedVehicleType == vehicle['type'] ? AppTheme.primaryColor : AppTheme.textSecondary,
            ),
            title: Text(
              vehicle['name'] as String,
              style: AppTheme.bodyLarge.copyWith(
                color: _selectedVehicleType == vehicle['type'] ? AppTheme.primaryColor : AppTheme.textPrimary,
