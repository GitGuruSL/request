...
enum ItemCondition { new_item, like_new, good, fair, poor, any }
  ...
  Future<void> _submitRequest() async {
    ...
    try {
      await _requestService.createRequest(
        ...
        condition: _selectedCondition.name, // Using selected condition for items
  ...
  String _getConditionText(ItemCondition condition) {
    switch (condition) {
      case ItemCondition.new_item:
        return 'New - Brand new item';
      case ItemCondition.like_new:
        return 'Like New - Barely used';
      case ItemCondition.good:
        return 'Good - Lightly used';
      case ItemCondition.fair:
        return 'Fair - Moderately used';
      case ItemCondition.poor:
        return 'Poor - Heavily used';
      case ItemCondition.any:
        return 'Any - Any condition';
    }
  }
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: 'Describe the item you need in detail...',
                  border: InputBorder.none,
                  enabledBorder: InputBorder.none,
                  focusedBorder: InputBorder.none,
                  errorBorder: InputBorder.none,
