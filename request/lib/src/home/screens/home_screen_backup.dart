...
// FIRESTORE_TODO: replace with REST service. Original: FirebaseFirestore.instance.collection('requests'));
      ...
      if (e.code == 'failed-precondition') {
        ...
        _usingFallback = true;
        try {
// FIRESTORE_TODO: replace with REST service. Original: final fallbackSnapshot = await FirebaseFirestore.instance
