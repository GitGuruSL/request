...
import 'src/screens/business_documents_view_screen.dart';       // Business documents view
    ...
    return MaterialApp(
      ...
      onGenerateRoute: (settings) {
        switch (settings.name) {
          ...
          case '/business-documents-view':
            return MaterialPageRoute(builder: (context) => const BusinessDocumentsViewScreen());
